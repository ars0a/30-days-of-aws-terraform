...
## Overview
We have demonstrates how to manage AWS IAM users, groups, and group memberships using Terraform and a CSV file as the data source. It's an AWS equivalent of Azure AD user management.

## What we are going to Created
...
```powershell
aws s3 mb s3://terraform-day16-bucket-aditya 
--region us-east-1
aws s3api put-bucket-versioning --bucket terraform-day16-bucket-aditya
...
AWS IAM infrastructure is now managed as code. We can:
