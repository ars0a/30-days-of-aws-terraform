...
By the end of Day 8, Terraform had already stopped feeling like a simple provisioning tool. Meta-arguments (count, for_each, depends_on) showed me how Terraform can dynamically create infrastructure based on patterns instead of repetition.

Day 9 pushed that understanding further, but in a different direction.
