...
The goal of this project was to create two VPCs in different AWS regions, establish a VPC peering connection between them, and verify private communication between EC2 instances across regions.

This project helped solidify core networking concepts such as routing, security groups, provider aliases, and Terraform backends.
